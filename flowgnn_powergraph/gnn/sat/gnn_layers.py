# Original code from:
# https://github.com/BorgwardtLab/SAT/tree/main

import torch
from torch import nn
import torch.nn.functional as F
from gnn.conv import FlowTransformerConv
...
def get_simple_gnn_layer(gnn_type, embed_dim, **kwargs):
    ...
    if gnn_type == "graph":
        ...
        return TransformerConv(
            embed_dim, embed_dim, heads=4, edge_dim=edge_dim, concat=False
        )
    elif gnn_type == "flowtransformer":
        return FlowTransformerConv(
            embed_dim, embed_dim, heads=4, edge_dim=edge_dim, concat=False
        )
    else:
